...
public class UsersNewServletTest {
    ...
    @Test
    public void shouldForwardToUsersNewJsp() throws Exception {
        when(request.getRequestDispatcher(InternalResource.USERS_NEW_JSP
                .getPath())).thenReturn(requestDispatcher);
